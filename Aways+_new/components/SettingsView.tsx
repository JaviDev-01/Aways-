    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
            ...
            <div className="bg-surface border-[3px] border-main p-5 neo-shadow-sm space-y-4 h-full">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-surface border-[3px] border-main p-5 space-y-6 neo-shadow-sm h-full">
              ...
              <div className="space-y-3">
               ...
               <div className="pt-4 space-y-2 border-t border-main/10 mt-4">
                  <button onClick={() => setIsPrivacyModalOpen(true)} className="w-full flex items-center justify-between p-2 hover:bg-main/5 text-[10px] font-black uppercase text-main">
                      <div className="flex items-center gap-2"><ShieldCheck size={14} /> Política de Privacidad</div>
